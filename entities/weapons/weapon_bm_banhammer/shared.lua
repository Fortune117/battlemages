...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_Spine4"] = { scale = Vector(1, 1, 1), pos = Vector(0, -2, 0), angle = Angle(0, 0, 0) }
}
SWEP.VElements = {
	["ban_hammer"] = { type = "Model", model = "models/banhammer/banhammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.799, 1.557), angle = Angle(0, 0, 180), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["ban_hammer"] = { type = "Model", model = "models/banhammer/banhammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.5, 3.635), angle = Angle(-5, -15, 175), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.swingAnim            = ACT_VM_MISSCENTER
...
SWEP.swingSounds = { Sound( "npc/zombie/claw_miss1.wav" ), Sound( "npc/zombie/claw_miss2.wav" ) }
SWEP.hitSounds   =
{
...
function SWEP:swing()
    ...
    self.Owner:LagCompensation( true )
        ...
        if ( tr.Hit && !( game.SinglePlayer() && CLIENT ) ) then
            self:EmitSound( tostring( table.Random( self.hitSounds ) ) )

            util.ScreenShake( tr.HitPos, 1, 30, 0.2, 50 )
...
if CLIENT then
    local buffColor = Color( 25, 102, 255, 255 )
    hook.Add( "PreDrawHalos", "powerSlapHalo", function()
